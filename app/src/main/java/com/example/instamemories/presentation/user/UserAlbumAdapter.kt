...
class UserAlbumAdapter(val onClickListener: OnClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val binding: RecyclerViewAlbumsBinding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.recycler_view_albums, parent, false
        )
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.albumTitle.setOnClickListener {
            onClickListener.onClick(albumsList.get(position))
        }
    }
